<?php
	...
	if (@$_GET['delete'] == 1)
	{
		...
		$breadcrumbs->addElement($lang->get('edit_entry'), makeURL($mod, array('mode' => 'edit', 'day' => $day, 'view' => $view, 'calendarid' => $calendarid)));
		...
		if (isset($_POST['save']))
		{
			...
			{	
				...
				$notify->add($lang->get('calendar'), $lang->get('new_entry_fill'));
			}
		...
		$smarty->assign('head', $lang->get('edit_entry'));
	}
?>